...
ARTICLE_PATH = '../test_pdfs/comp_sci_article.pdf' # This is the path to the PDF file to be summarized, it will need to point to temporary cloud storage path when deployed.
CHUNK_SIZE = 4000  # This determines the size (in characters) of each chunk of text to be summarized
SUMMARY_LENGTH = 1000  # This determines the desired length (in characters) of the final summary
...
async def fetch_summary(session, chunk, summary_length, num_chunks):
    ...
    """
    max_tokens = summary_length // num_chunks  # Divide the desired summary length by the number of chunks.
                                               # This ensures each chunk gets a proportional summary regardless of the length of the original text.
